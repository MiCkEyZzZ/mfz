    ...
    <div className="mt-3 flex w-full flex-col px-0 py-5">
      ...
      <div className="mt-2 flex w-full flex-col">
        ...
        <div className="mt-2 flex w-full flex-col items-center justify-start">
          <button
            type="submit"
            className="mr-0 ml-auto transform-gpu rounded-md border border-transparent bg-black px-4 py-2 text-base font-medium text-white transition-all duration-300 hover:scale-105 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-800 dark:border-white dark:hover:bg-white dark:hover:text-black md:leading-6"
          >
            Отправить
          </button>
        </div>
